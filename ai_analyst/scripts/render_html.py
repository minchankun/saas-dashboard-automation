...
def build_report_header(ctx: dict, stem: str, generated: str) -> str:
    ...
    return (
        ...
        f'<span style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:20px;padding:4px 12px;font-size:12px;color:#64748B;font-weight:500;">SaaS Analysis</span>'
